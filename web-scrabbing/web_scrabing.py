...
<UL>
<LI class="omar">create your own simple pages
<LI class="omar">read and appreciate pages created by others
<LI class="omar">develop an understanding of the creative and literary implications of web-texts
<LI class="omar">have the confidence to branch out into more complex web design 
</UL></P>
...
#print(type(soup))
attr1 = soup.find('body').attrs
attr2 =soup.find('body')['bgcolor']
print(attr1)
print(attr2)
test = soup.find(href="webpage2.html")
#print(type(test))

#print(test.get_text())
#print(soup.body.p)
for el in soup.select(".omar"):
	print(el.attrs)
...
#data = soup.body.contents[1].next_sibling # gives the next tag in the same hirarechy
data = soup.find(class_="omar").parent.parent
print(data)